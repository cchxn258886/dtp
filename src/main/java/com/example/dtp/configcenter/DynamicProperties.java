package com.example.dtp.configcenter;


import com.example.dtp.common.constant.DynamicTpConstant;
import com.example.dtp.entity.DtpExecutorProps;
import com.example.dtp.entity.NotifyPlatform;
import com.example.dtp.entity.TpExecutorProps;
import com.example.dtp.enums.CollectorTypeEnum;
import lombok.Data;
...
/**
 * @Author chenl
 * @Date 2023/4/26 4:44 下午
 */
@Slf4j
@Data
@ConfigurationProperties(prefix = DynamicTpConstant.MAIN_PROPERTIES_PREFIX)
@Configuration
public class DynamicProperties {
     ...
     */
    private List<String> collectorTypes = Arrays.asList(CollectorTypeEnum.MICROMETER.name());
