...
/**
 * @Author chenl
 * @Date 2023/4/24 8:01 下午
 * 时间轮算法实现Timer copy from dubbo and netty
 */
@Slf4j
public class HashedWheelTimer implements Timer {
    public static final String NAME = "hashd";
    ...
    public HashedWheelTimer(
        ...
        // Convert tickDuration to nanos. 默认100
    ...
    /**
     * @return the number of pending timeouts of this {@link java.util.Timer}.
     */
    ...
    private static final boolean IS_OS_WINDOWS = System.getProperty(DynamicThreadPoolConstant.OS_NAME_KEY, "").toLowerCase(Locale.US).contains(DynamicThreadPoolConstant.OS_WIN_PREFIX);
